...
def split_image(image_path):
    ...
    with Image.open(image_path) as img:
        ...
        if width != 1536 or height != 512:
            raise ValueError("Image dimensions must be 1536x512")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Split an image into three parts.')
